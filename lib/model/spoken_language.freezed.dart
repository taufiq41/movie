...
class _$SpokenLanguageImpl implements _SpokenLanguage {
  ...
  @override
  String toString() {
    return 'SpokenLanguage(englishName: $englishName, iso: $iso, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, englishName, iso, name);
...
abstract class _SpokenLanguage implements SpokenLanguage {
  factory _SpokenLanguage(
      ...
      @JsonKey(name: 'iso_639_1') final String iso,
